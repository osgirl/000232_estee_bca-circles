	                ...
	                <div id='top_content'>
		             	<div class="row">
			                <div class="top_content_span span6">
			                    <div id="big_image"><img src='<?= base_url(); ?>img/pics/stronger-together-new2.jpg'/>
				                    <div id="tagline">
			                ...
			                <div class="top_content_span span6">
			                	<div class="row">
			                		<div id='featured_header' class="span6">
			                			...
			                			<div class='pull_left'>
											<div id="dot0" class='featured_selected featured_dot'></div>
											<div id="dot1" class='featured_deselected featured_dot'></div>
											<div id="dot2" class='featured_deselected featured_dot'></div>
										</div>
			                		</div> 
			                    </div>
			                    <div id="carousel">
	        ...
	        <div id='donate_area'>
	        	<div id="regular_footer" style="width:100%">
					...
					<div id='watch_video' class="span5">
						<div><a  href="#video" onclick="return $.popup({type:'video'});"><img src="<?= base_url(); ?>img/assets/video-thumb-new3.png"/></a></div>
