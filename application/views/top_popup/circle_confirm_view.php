<div id="circle_confirm_screen">
	...
	<div id="opt_in">
		<div class="confirm_content">
			<p language_id="opt_copy" language_location="home" >
				By providing my information, I acknowledge that I have read, understand and agree to the <a onclick="$.popup({type:'terms_and_conditions'});">Terms and Conditions</a> and <a onclick="$.popup({type:'privacy_policy'});">Privacy Policy</a>.  I agree any personal information that I may provide here will be processed in 
		...
		<table class="btn_control">
			<tr>
				...
				<td class="button_right_wrapper"><a id="final_create_btn" class='pink_btn pull-left dim' language_id="create" language_location="home" >create</a></td>
			</tr>
		</table>
	</div>
	<div id="create_loading">
		<div class="confirm_content">
			<p language_id="creating_circle" language_location="home" >
	...
	<div id="thank_you">
		<div class="confirm_content">
			<p language_id="thank_you_creating_circle_copy" language_location="home" >
		...
		<table class="btn_control">
			<tr>
			    <td style="text-align:center"><a id="close_create_circle_btn" class='pink_btn pull_right' language_id="close" language_location="home" >close</a></td>
			</tr>
		</table>
	</div>
</div>