<div class="popup" id="popup_about">
	<img id="about_mrs_lauder" src="img/popups/about/photo-mrs_lauder.jpg"/>
	<div id="about_content">
		<img id="about_header" src="img/popups/about/about-header.jpg"/>
		<img id="about_logo" src="img/popups/about/about-logo.jpg"/>
		<p id="about_indent_p">In 1992, during a time when thousands were dying from breast cancer yet it was only spoken about in whispers,</p>
		<p>Evelyn H. Lauder launched The Estée Lauder Companies’ Breast Cancer Awareness (BCA) Campaign to raise awareness for the disease. She encouraged women everywhere to
